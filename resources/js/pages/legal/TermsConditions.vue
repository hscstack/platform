            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <li>৫ ধরনের স্ট্রাকচার্ড রিসোর্স: নোটস, প্রশ্ন, PDF, ছবি এবং ভিডিও।</li>
                        <li>রিয়েল-টাইম কমিউনিটি লাইভ চ্যাট, এডুকেশনাল ব্লগ এবং ইউজার প্রোফাইল।</li>
                        <li>রিসোর্স কমপ্লিশন ট্র্যাকিং এবং এআই অ্যাসিস্ট্যান্ট সুবিধা।</li>
                    </ul>
                </div>
            </div>
