        ...
        return () => (
            <>
                ...
                <div class={adminPageClass}>
                    {/* Header */}
                    <AdminPageHeader
                        title="Global Chat Management"
                        description="Manage realtime student lounge access, rate limits, cooldown intervals, and moderation."
                    >
                        {{
                            actions: () => (
                                    ...
                                    return (
                                        <button
                                            ...
                                            class={[
                                                ...
                                                isActive
                                                    ? isDisabledOption
                                                        ? 'bg-white text-rose-600 shadow-2xs ring-1 ring-slate-900/5 dark:bg-gray-700 dark:text-rose-300 dark:shadow-none dark:ring-0'
                                                        : adminSegmentedActiveClass
                                                    : adminSegmentedIdleClass,
                                            ]}
                                        >
