    ...
    <div class="flex w-full flex-1 flex-col">
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
            ...
            >
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-slate-500 dark:text-gray-400">
                        Choose how each resource title will be generated during
                        import.
                    </p>
                </div>
                ...
                >
                    <span v-if="form.naming_strategy === 'youtube'">
                        💡 <strong>Example:</strong> Uses original YouTube video
                        names (e.g., <em>HTML Introduction</em>,
                        <em>HTML Image Tag</em>).
                    </span>
                    <span v-else-if="form.naming_strategy === 'serial'">
                        💡 <strong>Example:</strong> Formats titles sequentially
                        (e.g., <em>01</em>, <em>02</em>, <em>03</em>).
                    </span>
                    <span v-else-if="form.naming_strategy === 'prefix'">
                        💡 <strong>Example:</strong> Combines your prefix and
                        sequence (e.g., <em>Lecture 01 - 01</em>,
                        <em>Lecture 01 - 02</em>).
                    </span>
                </p>
                ...
                >
                    ...
                    <div>
                        ...
                        <p
                            class="mt-1 text-[11px] text-slate-400 dark:text-gray-500"
                        >
                            Number to begin incrementing from (default is 1).
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                >
                    Playlists containing more than 50 videos will automatically
                    page through and import all available lessons sequentially.
                </p>
            </div>
