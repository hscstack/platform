...
<template>
    ...
    <div class="flex w-full flex-1 flex-col">
        <div class="mb-8 border-b border-slate-200 pb-6 dark:border-gray-800">
            <h1
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-gray-400">
                Configure the announcement dialog shown on the home page. Only
                one notice is displayed at a time.
            </p>
        </div>
