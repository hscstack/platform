...
export default defineComponent({
    ...
    setup(props) {
        ...
        // Replacement selections revoke eagerly in `handleAvatarSelect`;
        // this covers navigating away with a preview still active.
        onUnmounted(() => {
