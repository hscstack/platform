        ...
        <form @submit.prevent="submitForm" class="max-w-3xl space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span
                            class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-sm font-medium text-slate-400 dark:text-gray-500"
                            >@</span
                        >
                        <input
            ...
            >
                <div>
                    ...
                    <p class="text-xs text-slate-500 dark:text-gray-400">
                        Select the features this editor is authorized to modify.
                    </p>
                </div>
            ...
            >
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div class="space-y-1 border-l-2 border-red-500 pl-3">
                        ...
                        >
                            Superuser control. Automatically has all permissions
                            system-wide.
                        </div>
                    </div>
