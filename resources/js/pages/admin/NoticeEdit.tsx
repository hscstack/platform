        ...
        return () => (
            <>
                ...
                <div class={adminPageClass}>
                    ...
                    <AdminPageHeader
                        title="Site Notice"
                        description="Configure the announcement dialog shown on the home page. Only one notice is displayed at a time."
                    >
                        {{
                            actions: () => (
                                <>
