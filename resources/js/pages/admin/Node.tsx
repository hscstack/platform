...
export default defineComponent({
    ...
    setup(props) {
        ...
        const menuPanelClass =
            'absolute right-0 z-10 mt-1.5 w-48 rounded-xl border border-slate-100 bg-white p-1 shadow-lg dark:border-gray-800 dark:bg-gray-900';

        const menuItemClass =
            'block w-full cursor-pointer rounded-lg px-3 py-2 text-left text-xs font-medium text-slate-700 transition hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-indigo-500 active:scale-95 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-gray-100';
                ...
                <div class={adminPageClass}>
                    ...
                    <div class={adminPageHeaderClass}>
                        ...
                        <div class="flex shrink-0 items-center gap-2">
                            {/* Bulk Rename (lives with the other actions, not floating over the list) */}
                            {can('edit resources') &&
