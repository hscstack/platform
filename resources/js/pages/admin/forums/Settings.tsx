    ...
    setup(props: ForumSettingsProps) {
        ...
        return () => (
            <>
                ...
                {/* Header + switcher stay full-width like Discussions/Reports;
                    only the form narrows for readability. */}
                <div class={adminPageClass}>
                    ...
                    <AdminPageHeader
                        ...
                        count={
                            props.pendingReportsCount > 0
                                ? `${props.pendingReportsCount} pending`
                                : undefined
                        }
                        countTone="amber"
                        description="Configure question approval mode, availability, and moderation triggers."
                    >
                        {{
                            actions: () => (
                                <button
                    ...
                    <form onSubmit={submitSettings} class="max-w-4xl space-y-5">
                        {/* 1. Approval */}
                        <section class="space-y-3">
                            ...
                            >
                                <label
                                    class={[
                                        'cursor-pointer rounded-lg px-2.5 py-1 text-xs font-semibold transition-all active:scale-95 has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-indigo-500',
