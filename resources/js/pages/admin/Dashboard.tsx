                ...
                <>
                    ...
                    <div class={adminPageClass}>
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <h1 class={adminPageTitleClass}>Dashboard</h1>
                        ...
                        {/* Load errors render above every branch so a failed
                            first fetch is never silent. */}
                        {errorMsg.value && (
                                            ...
                                            {stats.value?.top_sources?.map(
                                                (source, index) => {
                                                    ...
                                                    return (
                                                        <li
                                                            key={index}
                                                            class="flex items-center gap-3 border-b border-slate-100 px-3 py-3 dark:border-gray-800"
                                                        >
