...
import { Ban, Clock, Loader2, X } from 'lucide-vue-next';
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                ...
                <div
                    class="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-gray-800 dark:bg-gray-900"
                >
                    <!-- Close button -->
                    <button
                        type="button"
                        @click="handleClose"
                        class="absolute top-4 right-4 cursor-pointer rounded-xl p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-gray-800 dark:hover:text-gray-300"
                    >
                        <X class="h-4 w-4" />
                    </button>
