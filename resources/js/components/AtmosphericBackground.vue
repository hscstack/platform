...
/**
 * Shared atmospheric background — the login-page look, everywhere.
 * Renders the layout's indigo/sky/rose radial washes plus the
 * indigo/violet atmospheric blobs, fixed behind content.
 */
</script>
