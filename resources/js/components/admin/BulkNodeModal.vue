...
<template>
    <BaseModal
        :is-open="isOpen"
        title="Bulk Add Folders"
        :description="`In: ${parent ? parent.name : subject.name}`"
        max-width="2xl"
        @close="handleClose"
    >
        <!-- Body -->
        ...
        >
            ...
            <div v-else class="space-y-3">
                ...
                <div class="max-h-80 space-y-2.5 overflow-y-auto pr-0.5">
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    @click="removeChildFromNode(nIdx, cIdx)"
